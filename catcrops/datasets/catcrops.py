...
class CatCrops(Dataset):
    ...
    def __init__(self,
                 ...
                 LST = True,                  #Use Landsat data:              True or False
        ...
        self.varietatmapping, self.L2A_csvfolder, self.L2A_h5path, self.LST_csvfolder, self.LST_h5path ,\
        self.ET_csvfolder, self.ET_h5path = self.build_folder_structure(self.root, self.year, self.level, self.region)
