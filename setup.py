...
setup(
    ...
    author_email='jordi.gene@irta.cat, magi.pamies@irta.cat',
    maintainer='Jordi Gené Mola, Magí Pàmies Sans',
    maintainer_email='jordi.gene@irta.cat, magi.pamies@irta.cat',
